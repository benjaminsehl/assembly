# Product Vision: Assembly

## User

Primary: Sai acting as founder/product director, using Codex across product, design, engineering, QA, and business decisions while retaining final product judgment.

Secondary: builders who want Codex to follow a coherent project lifecycle without manually juggling overlapping skills.
...
Assembly is the local protocol for a human-led agentic app factory: Codex can answer where the project is, what matters, what is missing, and what should happen next from evidence in the repo.
...
- Build Hermes orchestration, hosted dashboards, or a fully autonomous app factory before the human-led Codex control loop is excellent.
