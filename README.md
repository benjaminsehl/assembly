...
The script skips existing files by default. If the target repo already has `AGENTS.md`, the scaffold will not overwrite it; merge `templates/AGENTS.md` manually.
